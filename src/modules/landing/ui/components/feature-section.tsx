      ...
      <div className="rounded-xl p-8">
        ...
        <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-8 md:grid-cols-2 md:gap-16">
          ...
          <div className="relative">
            <div className="glass-card aspect-[4/3] overflow-hidden rounded-lg bg-gray-900">
              <div className="flex items-center gap-2 border-b border-gray-800 p-2 md:p-4">
        ...
        <div className="glass-card mx-auto mt-8 max-w-7xl rounded-xl border border-gray-800 p-8 text-center md:mt-12 md:p-12">
          <h3 className="font-geist mb-6 text-2xl font-bold text-white md:text-3xl">
            Ready to transform your deployment workflow?
          </h3>
          <p className="mx-auto mb-8 max-w-2xl text-gray-400">
            Join thousands of developers who&apos;ve already made the switch to
            Deplawyer. Get started today with our free tier.
          </p>
          <Button
            size="lg"
